...
import com.xuanxuan.mianshiya.config.WxOpenConfig;
...
import com.xuanxuan.mianshiya.model.dto.user.UserAddRequest;
import com.xuanxuan.mianshiya.model.dto.user.UserLoginRequest;
import com.xuanxuan.mianshiya.model.dto.user.UserQueryRequest;
import com.xuanxuan.mianshiya.model.dto.user.UserRegisterRequest;
import com.xuanxuan.mianshiya.model.dto.user.UserUpdateMyRequest;
import com.xuanxuan.mianshiya.model.dto.user.UserUpdateRequest;
import com.xuanxuan.mianshiya.model.entity.User;
import com.xuanxuan.mianshiya.model.vo.LoginUserVO;
...
import static com.xuanxuan.mianshiya.service.impl.UserServiceImpl.SALT;
...
public class UserController {
    ...
    public BaseResponse<List<Integer>> getSignIn(Integer year, HttpServletRequest request){
        User loginUser = userService.getLoginUser(request);
        List<Integer> result = userService.getUserSignIn(loginUser.getId(), year);
        return ResultUtils.success(result);
    }
}
